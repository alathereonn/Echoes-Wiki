...
<footer class="bg-gray-900 border-t border-white/10">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <span class="text-heading self-center text-2xl text-pink-500 font-semibold whitespace-nowrap">ECHOES</span>
                  <ul class="text-body text-white font-medium">
                      <li class="mb-4">
                          <a>Your ultimate source for ECHOES information, characters, and lore.</a>
                      </li>
                  </ul>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm text-white font-semibold text-heading uppercase"></h2>
                  <ul class="text-body text-white font-medium">
                      <li class="mb-4">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-body text-white sm:text-center">© 2025 <RouterLink to="/" class="hover:underline">ECHOES: The Undying Follower™. All Rights Reserved.</RouterLink>
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            <a href="https://web.facebook.com/profile.php?id=100055464836367" class="text-body text-white hover:text-heading">
            ...
            <a href="#" class="text-body text-white hover:text-heading ms-5">
            ...
            <a href="https://www.instagram.com/alathereonn_" class="text-body text-white hover:text-heading ms-5">
                <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5h10c2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5H7zm0 2h10c1.66 0 3 1.34 3 3v10c0 1.66-1.34 3-3 3H7c-1.66 0-3-1.34-3-3V7c0-1.66 1.34-3 3-3zm5 3.5A4.5 4.5 0 1 0 16.5 12 4.505 4.505 0 0 0 12 7.5zm0 2A2.5 2.5 0 1 1 9.5 12 2.503 2.503 0 0 1 12 9.5zM17.75 6a1.25 1.25 0 1 0 1.25 1.25A1.25 1.25 0 0 0 17.75 6z"/></svg>
                <span class="sr-only">Instagram page</span>
            </a>
            <a href="https://github.com/alathereonn" class="text-body text-white hover:text-heading ms-5">
